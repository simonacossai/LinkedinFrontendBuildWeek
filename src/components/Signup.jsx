                        ...
                        <Col md={9} className="signupContainer text-left px-4 py-3 mt-0">
                            <Row>
                                ...
                                <Col md={6}>
                                    ...
                                    <label htmlFor="title" className="text-left">Your title</label>
                                    <InputGroup className="mb-3">
                                        <InputGroup.Prepend >
                                            <InputGroup.Text id="title"><FaGraduationCap /></InputGroup.Text>
                                        </InputGroup.Prepend>
                                        <FormControl
                                            placeholder="title"
                                            aria-label="title"
                                    ...
                                    <label htmlFor="area" className="text-left">Your area</label>
                                    <InputGroup className="mb-3">
                                        <InputGroup.Prepend >
                                            <InputGroup.Text id="area"><MdPlace/></InputGroup.Text>
                                        </InputGroup.Prepend>
                                        <FormControl
                                            placeholder="area"
                                            aria-label="area"
                                    ...
                                    <label htmlFor="bio" className="text-left">Your bio</label>
                                    <InputGroup className="mb-1">
                                        <InputGroup.Prepend >
                                            <InputGroup.Text id="bio" ><BsFillChatSquareDotsFill /></InputGroup.Text>
                                        </InputGroup.Prepend>
                                        <FormControl type="text" id="bio" placeholder="bio"
                            ...
                            <Row  className="text-center loginRow mt-2">
                                <Col md={8}>
                                    <p className="text-muted text-left login-p">By clicking join now you agree to the Linkedin User agreement, Privacy Policy, and Cookie Policy</p>
                                    <Button size="md" className="loginButton" style={{width:"100%"}} active onClick={(e) => this.Signup(e)}>
                                    Sign up
                                    </Button>{' '}
