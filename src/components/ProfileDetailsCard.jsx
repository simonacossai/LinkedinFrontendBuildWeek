...
export default class ProfileDetailsCard extends Component {
    ...
    render() {
        return (   
                <Card className="profile-detail-card d-flex justify-content-center align-items-center">
                ...
                <Card.Body className="pb-2">
                    ...
                    <hr style={{width:"100%"}} className="px-0 mx-0"></hr>
                    <Card.Text className="d-flex justify-content-between small-text-profile-detail"><p>Who viewed your profile</p> <p className="little-blue-numbers-detail ml-2">151</p> </Card.Text>
                    <Card.Text className="d-flex justify-content-between small-text-profile-detail"><p>Views for the video </p> <p className="little-blue-numbers-detail ml-2">426</p></Card.Text>
